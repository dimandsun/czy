...
import com.czy.fish_game.model.AmmoParticleEffect;
import com.czy.fish_game.model.GoldParticleEffect;
import com.czy.fish_game.model.NetParticleEffect;
...
public class ParticleEffectManager {
	...
	private ParticleEffectManager(){
		try {
			startParticleImg = ImageManager.getImageMnagaer().getscaleImageByScreenFromAssets("image/cannon/stars.png");
