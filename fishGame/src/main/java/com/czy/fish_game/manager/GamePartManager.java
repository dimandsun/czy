...
import com.czy.fish_game.model.BackGround;
import com.czy.fish_game.model.GamingInfo;
import com.czy.fish_game.model.componets.BottomTime;
...
public class GamePartManager {
	...
	private GamePartManager(){
		try {
            Object xml = XmlManager.getXmlParser("config/plist", "UTF-8");
			initGamePart(xml);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 */
	private void initGamePart(Object xml){
		//循环所有的关卡
