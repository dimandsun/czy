...
import com.czy.fish_game.model.componets.*;
...
public class LayoutManager {
	...
	public void init(){
		try {			
			...
			//初始化提高大炮质量的按钮
			ButtonAdapter upCannon = new ButtonAdapter(ImageManager.getImageMnagaer().getscaleImageByScreenFromAssets("image/cannon/add.png"),new UpCannonButtonListener());
			...
			//初始化降低大炮质量的按钮
			ButtonAdapter downCannon = new ButtonAdapter(ImageManager.getImageMnagaer().getscaleImageByScreenFromAssets("image/cannon/sub.png"),new DownCannonButtonListener());
