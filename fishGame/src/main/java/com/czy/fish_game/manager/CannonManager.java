package com.czy.fish_game.manager;

import com.czy.fish_game.base.graphics.Bitmap;
import com.czy.fish_game.constants.Constant;
import com.czy.fish_game.model.Ammo;
import com.czy.fish_game.model.FishingNet;
import com.czy.fish_game.model.GamingInfo;
import com.czy.fish_game.model.WaterRipple;
import com.czy.fish_game.model.componets.Cannon;
import com.czy.fish_game.model.componets.ChangeCannonEffect;
import com.czy.fish_game.threads.ShotThread;
import com.czy.fish_game.tools.LogTools;
import com.czy.fish_game.tools.Tool;
...
public class CannonManager {
	...
	public void init(){
		try {
			//获取配置文件指定的所有图片
			HashMap<String,Bitmap> allImage = ImageManager.getImageMnagaer().getImagesMapByImageConfig(ImageManager.getImageMnagaer().createImageConfigByPlist("image/cannon/bulletandnet"), ImageManager.getImageMnagaer().scaleNum);
			allImage.putAll(ImageManager.getImageMnagaer().getImagesMapByImageConfig(ImageManager.getImageMnagaer().createImageConfigByPlist("image/cannon/fire"), ImageManager.getImageMnagaer().scaleNum));
			//初始化金币数字
			...
			initNet(allImage);
			//初始化水波纹
			initWaterRipple(ImageManager.getImageMnagaer().getImagesMapByImageConfig(ImageManager.getImageMnagaer().createImageConfigByPlist("image/cannon/ripple"), ImageManager.getImageMnagaer().scaleNum));
			//初始化大炮
			initCannon(allImage);
			//初始化激光
	...
	private void initChangeCannonEffect(){
		HashMap<String,Bitmap> allEffect = ImageManager.getImageMnagaer().getImagesMapByImageConfig(ImageManager.getImageMnagaer().createImageConfigByPlist("image/cannon/changefire"), ImageManager.getImageMnagaer().scaleNum);
