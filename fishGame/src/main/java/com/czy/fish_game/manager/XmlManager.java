...
public class XmlManager {
	 ...
	 * @return
	 */
	public static Object getXmlParser(String fileName,String encode){
		try{
...
//			XmlPullParserFactory factory = XmlPullParserFactory.newInstance();
	 ...
	 * @return
	 */
	public static String getValueByCurrentTag(Object xml) {
		/*try {
	 ...
	 */
	public static boolean gotoTagByTagName(Object xml, String tagName) {
		/*try {
			int eventType = xml.next();
			String key = null;
			while (true) {
