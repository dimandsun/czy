...
public class StackedBarChartTest extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        xy1.setName("xy1");
        var xy2 = new XYChart.Series<String,Number>(FXCollections.observableArrayList(new XYChart.Data<>("a", 10)
                , new XYChart.Data<>("b", 20), new XYChart.Data<>("c", 56)));
        xy2.setName("xy2");


        var bubbleChart = new StackedBarChart<>(x, y, FXCollections.observableArrayList(xy1, xy2));
