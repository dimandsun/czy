...
public class ResourceBundleTest extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        var file = FileUtil.getCodeFile("fx","com.czy.fx.test.test71_ResourceBundle.ResourceBundle.fxml");
//        var resourceBundle= ResourceBundle.getBundle("com.czy.fx.test.test71_ResourceBundle.language");
        var  resourceBundle= ResourceBundle.getBundle("com.czy.fx.test.test71_ResourceBundle.language");
