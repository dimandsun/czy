...
//        tableView.getFocusModel().focus();
       ...
       /* nameColumn.setComparator(new Comparator<String>() {
        ...
        //
//       tableView.getItems().sort(Comparator.comparing(test52_binding.User::getName));
        //        列
...
//                        box.setAlignment(Pos.CENTER);
     ...
     /*   tableView.setRowFactory(new Callback<TableView<test52_binding.User>, TableRow<test52_binding.User>>() {
            @Override
            public TableRow<test52_binding.User> call(TableView<test52_binding.User> param) {
                return new TableRow<>(){
                    @Override
                    protected void updateItem(test52_binding.User item, boolean empty) {
                        super.updateItem(item, empty);
                        if (empty||item==null){
                            return;
                        }
