...
import com.czy.frame.core.enums.QuestEnum;
import com.czy.frame.core.model.BeanModel;
import com.czy.frame.core.model.ProjectInfo;
import com.czy.frame.core.model.RouteModel;
import com.czy.frame.db.config.DataSourceEnum;
import com.czy.frame.db.model.MybatisInfo;
import com.czy.frame.db.model.TypeAliases;
import com.czy.frame.model.MyMap;
import com.czy.frame.model.OutPar;
import com.czy.frame.util.FileUtil;
...
public class CoreContainer {
    ...
    private final String frameGroupId = "com.czy.frame";
    ...
    public void setProjectInfo() {
        this.projectInfo = ProjectInfo.getInstance();
    }
    ...
    protected CoreContainer() {
        projectGroupIdList.add(frameGroupId);
        /*初始化框架*/
//        initProject();
    }
    ...
    public void setProjectInfo( Map<String, Object> projectMap) {
        if (projectMap != null) {
            ...
            if (projectName != null) {
                projectInfo.setProjectName(projectName.toString());
            }
        }
    }
