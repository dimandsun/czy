...
public enum SQLTypeEnum implements IEnum<String> {
    ...
    Update("update", UpdateSQLBuilder.class,"update {tableName} set {setContent}"),
    Select("select", SelectSQLBuilder.class,"select {} from {tableName}"),
    ...
    public Class<SQLBuilder> getSqlClass() {
        return sqlClass;
    }
